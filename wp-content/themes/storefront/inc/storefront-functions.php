...
function storefront_categorized_blog() {
 ...
 wp_enqueue_style( 'storefront-style', get_template_directory_uri() . '/custom.css', '', $storefront_version );
 wp_enqueue_style( 'storefront-style-animate', get_template_directory_uri() . '/assets/custom/animate.css', '', $storefront_version );
 // wp_enqueue_style( 'storefront-style-uikit', get_template_directory_uri() . '/assets/custom/uikit.min.css', '', $storefront_version );
